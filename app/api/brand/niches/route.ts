/**
 * app/api/brand/niches/route.ts
 * GET /api/brand/niches - List niche taxonomy
 */
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    // Call handler
    const result = await BrandAPIHandlers.handleGetNiches(admin);
    ...
    console.error("GET /api/brand/niches error:", error);
    return NextResponse.json(
      {
        ok: false,
