            ...
            return (
              <div
                ...
                className={`flex items-center gap-3 p-3 rounded-lg ${
                  isDone ? 'opacity-50' : isActive ? 'bg-zinc-900 border border-zinc-700' : 'opacity-30'
                }`}
              >
                <div className={`w-5 h-5 rounded-full flex items-center justify-center text-xs font-bold shrink-0 ${
                  isDone ? 'bg-green-700 text-green-200' : isActive ? 'bg-violet-600 text-white' : 'bg-zinc-800 text-zinc-500'
                }`}>
