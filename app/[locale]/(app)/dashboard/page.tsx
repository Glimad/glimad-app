...
export default async function DashboardPage() {
  ...
  if (!project) redirect(`/${locale}/onboarding`)

  // Run engines (server-side, on each dashboard load)
  ...
  if (policy.topMission) {
    ...
    // Check if there's an active instance for this mission
